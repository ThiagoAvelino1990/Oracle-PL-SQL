...
-- Utilizando || para a junção também dos valores
...
-- Função INSTR, retorna que posição está determinado caracter ou valor informado
...
-- Função LPAD, retorna o campo preenchido com o caracter informado a esquerda --> LPAD( Coluna_Requerida,Quantidade_de_Caracteres,'Valor_Preenchido' )
SELECT cod_aluno, LPad(COD_ALUNO,5,'0') FROM TALUNO;

-- Função LPAD, retorna o campo preenchido com o caracter informado a direita --> RPAD( Coluna_Requerida,Quantidade_de_Caracteres,'Valor_Preenchido' )
