...
--Novo registro 
insert into teste values (1, 'MARCIO');
...
--Habiliar índice para monitoramento
...
--Veja que a view v$OBJECT_USAGE, terá cada índice do seu esquema cujo uso está sendo monitorando, 
--  caso o índice não for usado, pode ser exclui-lo para melhorar performance de DML.
